...
const T: Record<string, Partial<Record<L, string>>> = {
  ...
  suggestions_promo:      { fr: 'Suggestions de promo flash', en: 'Flash promo suggestions', ar: 'اقتراحات عروض سريعة', wo: 'Suggestions promotion bu gaaw', bm: 'Promotion teliya laadilenw', ff: 'Waaɗe promotion yaawɗo', sw: 'Mapendekezo ya ofa za haraka', pt: 'Sugestões de promoção relâmpago' },
  suggestions_promo_sub:  { fr: 'Produits proches de la date de péremption', en: 'Products nearing their expiry date', ar: 'منتجات قريبة من تاريخ انتهاء الصلاحية', wo: 'Benn-benn yu jege bés wu jeex', bm: 'Jolisow minɛnna tɛmɛnnako', ff: 'Dewe ɓadiiɗe ñalawma yaltugol', sw: 'Bidhaa zinazokaribia tarehe ya mwisho', pt: 'Produtos perto da data de validade' },
  expire_dans:            { fr: 'Expire dans', en: 'Expires in', ar: 'تنتهي خلال', wo: 'Dina jeex ci', bm: 'Bɛɛ tɛmɛnna la', ff: 'Ko yaltata e', sw: 'Itaisha baada ya', pt: 'Expira em' },
  jours_unite:            { fr: 'j', en: 'd', ar: 'ي', wo: 'fan', bm: 'tile', ff: 'ñalawma', sw: 'siku', pt: 'd' },
  creer_promo_suggestion: { fr: 'Créer une promo', en: 'Create a promo', ar: 'إنشاء عرض', wo: 'Sos ab promotion', bm: 'Promotion sɔrɔ', ff: 'Fuɗɗir promotion', sw: 'Unda ofa', pt: 'Criar promoção' },
  produit_cible:          { fr: 'Produit ciblé', en: 'Targeted product', ar: 'المنتج المستهدف', wo: 'Benn-benn bu tanu', bm: 'Joli tanulen', ff: 'Dewe suɓaango', sw: 'Bidhaa inayolengwa', pt: 'Produto visado' },
  date_fin_promo:         { fr: 'Date de fin *', en: 'End date *', ar: 'تاريخ الانتهاء *', wo: 'Bés wu xàt *', bm: 'Laban don *', ff: 'Ñalawma haaɗtaare *', sw: 'Tarehe ya mwisho *', pt: 'Data de fim *' },
  date_fin_obligatoire:   { fr: 'La date de fin est obligatoire (AAAA-MM-JJ)', en: 'End date is required (YYYY-MM-DD)', ar: 'تاريخ الانتهاء مطلوب (YYYY-MM-DD)', wo: 'Bés wu xàt war na am (YYYY-MM-DD)', bm: 'Laban don wajibi ye (YYYY-MM-DD)', ff: 'Ñalawma haaɗtaare fotii wonaade (YYYY-MM-DD)', sw: 'Tarehe ya mwisho inahitajika (YYYY-MM-DD)', pt: 'Data de fim é obrigatória (AAAA-MM-DD)' },
  ...
  // ── Tutoriel vendeur ──────────────────────────────────────────────────────────
  tuto_vendeur_etape:            { fr: 'Étape',                    en: 'Step',                    ar: 'الخطوة',                        wo: 'Etapp',                      bm: 'Etapu',                    ff: 'Darnde',                    sw: 'Hatua',                     pt: 'Etapa' },
  tuto_vendeur_suivant:          { fr: 'Suivant',                  en: 'Next',                    ar: 'التالي',                        wo: 'Ci kanam',                   bm: 'Ɲɛfɛ',                     ff: 'Yeeso',                     sw: 'Endelea',                   pt: 'Seguinte' },
  tuto_vendeur_precedent:        { fr: 'Précédent',                en: 'Previous',                ar: 'السابق',                        wo: 'Ci ginnaw',                  bm: 'Kɔfɛ',                     ff: 'Ɓennun',                    sw: 'Rudi',                      pt: 'Anterior' },
  tuto_vendeur_titre_bienvenue:  { fr: 'Bienvenue',                en: 'Welcome',                 ar: 'مرحباً',                        wo: 'Dalal ak diam',              bm: 'I ni ce',                  ff: 'Jaɓɓorgol',                 sw: 'Karibu',                    pt: 'Bem-vindo' },
  tuto_vendeur_role_vendeur:     { fr: 'Vendeur',                  en: 'Seller',                  ar: 'بائع',                          wo: 'Jaaykat',                    bm: 'Jagatɔ',                   ff: 'Jiyɗo',                     sw: 'Muuzaji',                   pt: 'Vendedor' },
  tuto_vendeur_intro_texte:      { fr: "Ce petit guide vous montre comment démarrer avec l'application.", en: 'This short guide shows you how to get started with the app.', ar: 'يوضح لك هذا الدليل القصير كيفية البدء باستخدام التطبيق.', wo: 'Guide bii dana la wone nu jëfandikoo application bi.', bm: 'Guide nin bɛna a jira i la cogo min na i bɛ se ka baara kɛ application in na.', ff: 'Guide ndee firtay ma no fii huutortogol application ndii.', sw: 'Mwongozo huu mfupi unakuonyesha jinsi ya kuanza kutumia programu.', pt: 'Este pequeno guia mostra como começar a usar o aplicativo.' },
  tuto_vendeur_titre_vente:      { fr: 'Enregistrer une vente',    en: 'Record a sale',           ar: 'تسجيل عملية بيع',               wo: 'Bind benn jaay',             bm: 'Jaara kelen sɛbɛn',         ff: 'Winndito jeeytondiral',     sw: 'Kurekodi mauzo',            pt: 'Registar uma venda' },
  tuto_vendeur_texte_vente:      { fr: "Ajoutez les produits au panier depuis l'onglet Vente, choisissez le mode de paiement, puis validez. Le stock se met à jour automatiquement.", en: 'Add the sold products to the cart from the Sale tab, choose the payment method, then confirm. Stock updates automatically.', ar: 'أضف المنتجات المباعة إلى السلة من تبويب البيع، اختر طريقة الدفع، ثم أكد العملية. يتم تحديث المخزون تلقائياً.', wo: 'Yokk jaay yi ci panier bi ci onglet Jaay, tann ni ñu fey, wax ci "Valider". Stock bi dana update ci boppam.', bm: 'Fɛn minnu bɛ feere, u fara panier kan Jaara yɔrɔ la, i ka wari sarali cogo sugandi, o kɔ i ka a dabɔ. Marifa bɛna yɛlɛma i yɛrɛ ma.', ff: "Ɓeydu kulle jeeyaaɗe e panier caggal onglet Jeeyngo, suɓ peewal yoɓde, refti wattin. Ndeewoore ndee waɗtoto hino wattinoo ko'e mun.", sw: 'Ongeza bidhaa zilizouzwa kwenye kikapu kutoka kichupo cha Mauzo, chagua njia ya malipo, kisha thibitisha. Hesabu ya bidhaa itasasishwa kiotomatiki.', pt: 'Adicione os produtos vendidos ao carrinho na aba Venda, escolha a forma de pagamento e confirme. O estoque é atualizado automaticamente.' },
  tuto_vendeur_titre_credit:     { fr: 'Gérer un crédit',          en: 'Manage a credit',         ar: 'إدارة الائتمان',                wo: 'Wottu credit',               bm: 'Nanu kunnafoni ɲɛnabɔ',     ff: 'Toppitaade ɓoolol',         sw: 'Kusimamia mkopo',           pt: 'Gerir um crédito' },
  tuto_vendeur_texte_credit:     { fr: 'Pour vendre à crédit, choisissez le client puis le paiement « Crédit ». Pour régler un crédit existant, ouvrez Crédits clients et saisissez le montant reçu.', en: 'To sell on credit, select the client then choose "Credit" as payment method. To settle an existing credit, open Client credits and enter the amount received.', ar: 'للبيع بالائتمان، اختر العميل ثم طريقة الدفع "ائتمان". لتسديد ائتمان قائم، افتح "ائتمان العملاء" وأدخل المبلغ المستلم.', wo: 'Ngir jaay ci credit, tann jëkël bi te tann fey "Crédit". Ngir fey benn credit bu nekk, ubbil Crédits clients te bind xaalis bi ñu jot.', bm: 'Walasa ka feere kɛ nanu na, i ka kiliyeli sugandi ka tila ka wari sarali "Nanu" sugandi. Walasa ka nanu kɔrɔ dɛmɛ, i bɛ don Nanu kiliyeliw kɔnɔ ka wari sɔrɔlen sɛbɛn.', ff: 'Fii jeeyngo e ɓoolol, suɓ kiliyeljo refti suɓ yoɓde "Ɓoolol". Fii yoɓde ɓoolol ngoodɗo, uddit Ɓoolɗe kiliyaaɓe winndito kaalis heɓaaɗo.', sw: 'Kuuza kwa mkopo, chagua mteja kisha chagua njia ya malipo "Mkopo". Kulipa mkopo uliopo, fungua Mikopo ya wateja na uandike kiasi kilichopokelewa.', pt: 'Para vender a crédito, selecione o cliente e escolha a forma de pagamento "Crédito". Para quitar um crédito existente, abra Créditos de clientes e informe o valor recebido.' },
  tuto_vendeur_titre_fin:        { fr: 'Prêt à commencer ?',       en: 'Ready to start?',         ar: 'هل أنت مستعد للبدء؟',           wo: 'Ndax dëgg nga tàmbali?',      bm: 'I labɛnnen don ka daminɛ wa?', ff: 'A ɗaɓɓii fuɗɗaade?',       sw: 'Uko tayari kuanza?',        pt: 'Pronto para começar?' },
  tuto_vendeur_texte_fin:        { fr: 'Vous pouvez revoir ce tutoriel à tout moment depuis votre profil.', en: 'You can replay this tutorial anytime from your profile.', ar: 'يمكنك إعادة مشاهدة هذا الدليل في أي وقت من ملفك الشخصي.', wo: 'Man nga xool guide bii bés bu nekk ci sa profil.', bm: 'I bɛ se ka guide nin lajɛ tuma bɛɛ i ka profil kɔnɔ.', ff: 'Aɗa waawi yiylaade guide ndee sahaa fof e profil maa.', sw: 'Unaweza kuangalia tena mwongozo huu wakati wowote kutoka kwenye wasifu wako.', pt: 'Você pode rever este tutorial a qualquer momento no seu perfil.' },
  tuto_vendeur_bouton_fin:       { fr: 'Compris, commencer',       en: "Got it, let's start",     ar: 'فهمت، لنبدأ',                    wo: 'Dégg naa, nanu tàmbali',      bm: "Ne y'a faamu, an ka daminɛ", ff: 'Miɗo faami, en fuɗɗo',      sw: 'Nimeelewa, tuanze',         pt: 'Entendi, vamos começar' },
  tuto_vendeur_revoir:           { fr: 'Revoir le tutoriel',       en: 'Replay tutorial',         ar: 'إعادة مشاهدة الدليل',           wo: 'Xool guide bi',              bm: 'Guide lajɛ kokura',         ff: 'Yiylaade guide',            sw: 'Angalia tena mwongozo',     pt: 'Rever tutorial' },

  // ── Sauvegarde automatique programmée (ADMIN) ────────────────────────────────
  backup_titre:        { fr: 'Sauvegardes',                      en: 'Backups',                          ar: 'النسخ الاحتياطية',                    wo: 'Sauvegarde yi',                    bm: 'Sauvegarde ninnu',                ff: 'Sauvegarde ɗe',                    sw: 'Nakala rudufu',                     pt: 'Cópias de segurança' },
  backup_sous_titre:   { fr: 'Sauvegarde automatique programmée de la base de données', en: 'Scheduled automatic database backup', ar: 'نسخ احتياطي تلقائي مجدول لقاعدة البيانات', wo: 'Sauvegarde otomatik bu jub ci base de données bi', bm: 'Base de données ka sauvegarde otomatiki min bɛ labɛn', ff: 'Sauvegarde otomatik jaŋtaaɗo e base de données', sw: 'Uhifadhi wa kiotomatiki uliopangwa wa hifadhidata', pt: 'Cópia de segurança automática programada da base de dados' },
  backup_admin_only:   { fr: 'Accès réservé aux administrateurs.', en: 'Access restricted to administrators.', ar: 'الوصول مقتصر على المسؤولين.',        wo: 'Jubluwaay bi day yalla ngir jiitukat yi rekk.', bm: 'Donni in ye administrateur dɔrɔn ta ye.', ff: 'Naatirde ndee ko woodani ɓe fiɓnditotooɓe (admin) tan.', sw: 'Ufikiaji ni kwa wasimamizi pekee.', pt: 'Acesso reservado aos administradores.' },
  backup_col_fichier:  { fr: 'Fichier',                          en: 'File',                             ar: 'الملف',                                wo: 'Fichier',                          bm: 'Fisye',                           ff: 'Fichier',                           sw: 'Faili',                              pt: 'Ficheiro' },
  backup_col_date:     { fr: 'Date',                             en: 'Date',                             ar: 'التاريخ',                              wo: 'Date',                             bm: 'Date',                            ff: 'Date',                              sw: 'Tarehe',                             pt: 'Data' },
  backup_col_taille:   { fr: 'Taille',                            en: 'Size',                             ar: 'الحجم',                                wo: 'Yaatuwaay',                        bm: 'Bonya',                           ff: 'Mawnugol',                          sw: 'Ukubwa',                             pt: 'Tamanho' },
  backup_lancer:       { fr: 'Sauvegarder maintenant',           en: 'Back up now',                      ar: 'حفظ نسخة احتياطية الآن',               wo: 'Sauvegarde tey',                   bm: 'Sauvegarde kɛ sisan',             ff: 'Waɗ sauvegarde jooni',              sw: 'Hifadhi sasa',                       pt: 'Fazer backup agora' },
  backup_en_cours:     { fr: 'Sauvegarde en cours...',           en: 'Backing up...',                    ar: 'جارٍ إجراء النسخ الاحتياطي...',        wo: 'Sauvegarde bi ngi doon def...',    bm: 'Sauvegarde bɛ don kɛ...',         ff: 'Sauvegarde ngoni waɗeede...',       sw: 'Inahifadhi...',                      pt: 'Fazendo backup...' },
  backup_telecharger:  { fr: 'Télécharger',                      en: 'Download',                         ar: 'تحميل',                                wo: 'Jël',                              bm: 'Sɔrɔ',                            ff: 'Jaɓɓirde',                          sw: 'Pakua',                              pt: 'Baixar' },
  backup_confirm_titre:{ fr: 'Confirmer la sauvegarde',          en: 'Confirm backup',                   ar: 'تأكيد النسخ الاحتياطي',                wo: 'Dëgg sauvegarde bi',               bm: 'Sauvegarde dafali',               ff: 'Wonndu sauvegarde ndee',            sw: 'Thibitisha uhifadhi',                pt: 'Confirmar backup' },
  backup_confirm_texte:{ fr: 'Cette opération peut prendre quelques secondes. Continuer ?', en: 'This operation may take a few seconds. Continue?', ar: 'قد تستغرق هذه العملية بضع ثوانٍ. هل تريد المتابعة؟', wo: 'Liggéey bi mën na yàgg ay saa. Ndax dañu ko wara jëmmal?', bm: "Baara in bɛ se ka mɛn segondiw damina. I b'a fɛ ka taa ɲɛ wa?", ff: 'Golle ndee waawi yontaade seƴƴe seconde. Yeeyto?', sw: 'Operesheni hii inaweza kuchukua sekunde chache. Endelea?', pt: 'Esta operação pode demorar alguns segundos. Continuar?' },
  backup_succes:       { fr: 'Sauvegarde effectuée avec succès', en: 'Backup completed successfully',    ar: 'تم إجراء النسخ الاحتياطي بنجاح',      wo: 'Sauvegarde bi am na ci anam bu baax', bm: 'Sauvegarde in kɛra ka ɲɛ',       ff: 'Sauvegarde ndee waɗaama e nafoore', sw: 'Uhifadhi umefanikiwa',               pt: 'Cópia de segurança concluída com sucesso' },
  backup_erreur:       { fr: "Impossible d'effectuer la sauvegarde", en: 'Unable to perform the backup', ar: 'تعذر إجراء النسخ الاحتياطي',           wo: 'Mënula def sauvegarde bi',         bm: 'Sauvegarde in ma se ka kɛ',       ff: 'Waawaaka waɗde sauvegarde ndee',    sw: 'Imeshindwa kufanya uhifadhi',        pt: 'Não foi possível efetuar o backup' },
  backup_liste_vide:   { fr: 'Aucune sauvegarde disponible pour le moment.', en: 'No backup available at the moment.', ar: 'لا توجد نسخة احتياطية متاحة حالياً.', wo: 'Amul sauvegarde bu am fii ak léegi.', bm: 'Sauvegarde si sɔrɔ sisan.',      ff: 'Alaa sauvegarde e jaŋngo hannde.',  sw: 'Hakuna nakala rudufu kwa sasa.',     pt: 'Nenhuma cópia de segurança disponível no momento.' },
  backup_chargement:   { fr: 'Chargement des sauvegardes...',    en: 'Loading backups...',               ar: 'جارٍ تحميل النسخ الاحتياطية...',       wo: 'Charger sauvegarde yi...',         bm: 'Sauvegarde ninnu bɛ don sɔrɔ...', ff: 'Sauvegarde ɗen ngoni loowaade...',  sw: 'Inapakia nakala rudufu...',          pt: 'Carregando cópias de segurança...' },
};
